  ...
  private initializeData() {
    ...
    const sampleDentists: Dentist[] = [
      // Newcastle Dental Centre dentists
      {
        ...
        experience: 15,
        qualifications: "BDS (Newcastle), MFDS RCS (Eng), Royal College Excellence Award 2025",
        imageUrl: "https://images.unsplash.com/photo-1582750433449-648ed127bb54?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Thompson is the principal dentist with expertise in emergency dental care and advanced restorative procedures. Winner of the Royal College of Surgeons Excellence Award 2025.",
      ...
      },
      {
        ...
        experience: 13,
        qualifications: "BDS (Birmingham), MSc Periodontology, FDS RCS (Restorative Dentistry)",
        imageUrl: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Patel specializes in treating gum disease and maintaining periodontal health. She focuses on non-surgical and surgical periodontal treatments to preserve natural teeth.",
        languages: JSON.stringify(["English", "Hindi", "Gujarati"]),
        availableDays: JSON.stringify(["Tuesday", "Wednesday", "Friday", "Saturday"]),
        createdAt: new Date(),
      },
      {
        id: 7,
        ...
        name: "David MacLeod",
        title: "Dr.",
        specialization: "Orthodontics & Teeth Straightening",
        experience: 20,
        qualifications: "BDS (Glasgow), FDS RCS (Orthodontics), MOrth RCS (Ed)",
        imageUrl: "https://images.unsplash.com/photo-1582750433449-648ed127bb54?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. MacLeod is our senior orthodontist with extensive experience in both traditional braces and modern clear aligner treatments for patients of all ages.",
        languages: JSON.stringify(["English", "Scottish Gaelic"]),
      ...
      },
      {
        ...
        name: "Lisa Thompson",
        title: "Dr.",
        specialization: "Prosthodontics & Restorative Dentistry",
        experience: 17,
        qualifications: "BDS (Leeds), MSc Prosthodontics, FDS RCS (Restorative Dentistry)",
        imageUrl: "https://images.unsplash.com/photo-1594824694996-aec4a6f4ed73?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Thompson specializes in complex restorative work including crowns, bridges, and full mouth rehabilitations, combining function with aesthetic excellence.",
        languages: JSON.stringify(["English", "French"]),
        availableDays: JSON.stringify(["Monday", "Wednesday", "Thursday", "Saturday"]),
        createdAt: new Date(),
      },
      {
        id: 9,
        ...
        name: "Ahmed Hassan",
        title: "Dr.",
        specialization: "Oral Medicine & Special Care Dentistry",
        experience: 11,
        qualifications: "BDS (London), MSc Oral Medicine, MFDS RCS (Eng)",
        imageUrl: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Hassan specializes in treating patients with complex medical conditions and provides specialized care for those with anxiety, disabilities, and chronic illnesses.",
        languages: JSON.stringify(["English", "Arabic", "French"]),
        availableDays: JSON.stringify(["Tuesday", "Thursday", "Friday", "Saturday"]),
        createdAt: new Date(),
      },
      {
        id: 10,
        ...
        title: "Dr.",
        specialization: "Sedation Dentistry & Anxiety Management",
        experience: 9,
        qualifications: "BDS (Queen's Belfast), Diploma in Conscious Sedation, SAAD Certification",
        imageUrl: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. O'Neill specializes in helping anxious patients receive dental care through various sedation techniques and compassionate anxiety management approaches.",
        languages: JSON.stringify(["English", "Irish Gaelic"]),
        availableDays: JSON.stringify(["Monday", "Tuesday", "Wednesday", "Friday"]),
        createdAt: new Date(),
      },
      ...
      // Additional specialists for Newcastle Dental Centre
      {
        id: 15,
        practiceId: 1,
        name: "Rachel Murphy",
        title: "Dr.",
        specialization: "Dental Hygiene & Preventive Care",
        experience: 8,
        qualifications: "BSc Dental Hygiene (Edinburgh), Diploma in Oral Health Promotion",
        imageUrl: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Murphy specializes in preventive dental care and educating patients about optimal oral hygiene practices.",
        languages: JSON.stringify(["English", "Irish"]),
        availableDays: JSON.stringify(["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"]),
        createdAt: new Date(),
      },
      {
        ...
        title: "Dr.",
        specialization: "Maxillofacial Surgery & Trauma",
        experience: 19,
        qualifications: "BDS (Cambridge), FDS RCS (OMFS), Fellowship in Trauma Surgery",
        imageUrl: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Anderson is our maxillofacial surgeon specializing in complex facial trauma, jaw surgery, and oral pathology treatments.",
      ...
      },
      {
        ...
        title: "Dr.",
        specialization: "Geriatric Dentistry & Special Needs",
        experience: 11,
        qualifications: "BDS (Barcelona), MSc Geriatric Dentistry, Special Care Certification",
        imageUrl: "https://images.unsplash.com/photo-1594824694996-aec4a6f4ed73?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Martinez provides specialized dental care for elderly patients and those with special healthcare needs.",
        languages: JSON.stringify(["English", "Spanish", "Catalan"]),
        availableDays: JSON.stringify(["Tuesday", "Wednesday", "Friday", "Saturday"]),
        createdAt: new Date(),
      },
      {
        ...
        name: "Oliver Brooks",
        title: "Dr.",
        specialization: "Digital Dentistry & CAD/CAM",
        experience: 7,
        qualifications: "BDS (Sheffield), Certificate in Digital Dentistry, CEREC Specialist",
        imageUrl: "https://images.unsplash.com/photo-1582750433449-648ed127bb54?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Brooks leads our digital dentistry department, specializing in same-day crowns, digital impressions, and CAD/CAM technology.",
        languages: JSON.stringify(["English"]),
        availableDays: JSON.stringify(["Monday", "Tuesday", "Thursday", "Friday", "Saturday"]),
        createdAt: new Date(),
      },
      {
        id: 19,
        ...
        title: "Dr.",
        specialization: "Oral Pathology & Medicine",
        experience: 13,
        qualifications: "BDS (Damascus), MSc Oral Pathology (London), FDS RCS (Oral Medicine)",
        imageUrl: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Al-Zahra specializes in diagnosing and treating oral diseases, including oral cancer screening and complex oral medicine cases.",
        languages: JSON.stringify(["English", "Arabic", "French"]),
      ...
      },
      {
        ...
        title: "Dr.",
        specialization: "Sleep Dentistry & TMJ Disorders",
        experience: 9,
        qualifications: "BDS (Bristol), Diploma in Sleep Medicine, TMJ Specialist Certification",
        imageUrl: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Clarke treats sleep-related breathing disorders and temporomandibular joint problems using advanced therapeutic approaches.",
        languages: JSON.stringify(["English", "Welsh"]),
      ...
      },
      {
        ...
        name: "Isabella Rossi",
        title: "Dr.",
        specialization: "Laser Dentistry & Pain Management",
        experience: 10,
        qualifications: "DDS (Rome), Certificate in Laser Dentistry, Pain Management Specialist",
        imageUrl: "https://images.unsplash.com/photo-1594824694996-aec4a6f4ed73?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Rossi specializes in minimally invasive laser treatments and advanced pain management techniques for comfortable dental procedures.",
        languages: JSON.stringify(["English", "Italian", "Spanish"]),
        availableDays: JSON.stringify(["Monday", "Tuesday", "Wednesday", "Friday", "Saturday"]),
        createdAt: new Date(),
      },
      {
        id: 22,
        ...
        title: "Dr.",
        specialization: "Implant Prosthodontics & Full Mouth Reconstruction",
        experience: 21,
        qualifications: "BDS (Liverpool), MSc Prosthodontics, Fellowship in Implant Prosthodontics",
        imageUrl: "https://images.unsplash.com/photo-1582750433449-648ed127bb54?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Thompson specializes in complex implant-supported prosthetics and complete oral rehabilitation for patients with extensive dental needs.",
        languages: JSON.stringify(["English", "German"]),
        availableDays: JSON.stringify(["Monday", "Tuesday", "Thursday", "Friday"]),
        createdAt: new Date(),
      },
      {
        ...
        name: "Aisha Kumar",
        title: "Dr.",
        specialization: "Pediatric Oral Surgery & Orthodontics",
        experience: 8,
        qualifications: "BDS (Delhi), MSc Pediatric Dentistry, Certificate in Pediatric Oral Surgery",
        imageUrl: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Kumar combines pediatric dentistry expertise with specialized oral surgery skills, providing comprehensive care for children requiring surgical interventions.",
        languages: JSON.stringify(["English", "Hindi", "Punjabi", "Urdu"]),
        availableDays: JSON.stringify(["Monday", "Wednesday", "Thursday", "Friday", "Saturday"]),
        createdAt: new Date(),
      },
      {
        ...
        title: "Dr.",
        specialization: "Aesthetic Reconstruction & Veneers",
        experience: 15,
        qualifications: "BDS (Oxford), MSc Aesthetic Dentistry, Certificate in Smile Design",
        imageUrl: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Wright is renowned for his artistic approach to smile makeovers, specializing in porcelain veneers and comprehensive aesthetic reconstructions.",
        languages: JSON.stringify(["English", "French"]),
        availableDays: JSON.stringify(["Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]),
        createdAt: new Date(),
      },
      {
        ...
        name: "Elena Petrov",
        title: "Dr.",
        specialization: "Holistic Dentistry & Biocompatible Materials",
        experience: 12,
        qualifications: "DDS (Moscow), Certificate in Holistic Dentistry, Biocompatibility Specialist",
        imageUrl: "https://images.unsplash.com/photo-1594824694996-aec4a6f4ed73?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Petrov focuses on holistic dental approaches, using biocompatible materials and considering overall health impacts in dental treatment planning.",
        languages: JSON.stringify(["English", "Russian", "Ukrainian"]),
        availableDays: JSON.stringify(["Monday", "Tuesday", "Wednesday", "Thursday"]),
        createdAt: new Date(),
      },
      {
        ...
        name: "William Fraser",
        title: "Dr.",
        specialization: "Emergency Dentistry & Trauma Care",
        experience: 16,
        qualifications: "BDS (Aberdeen), Diploma in Emergency Medicine, Advanced Trauma Life Support",
        imageUrl: "https://images.unsplash.com/photo-1582750433449-648ed127bb54?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Fraser specializes in dental emergencies and trauma cases, providing immediate care for urgent dental situations and complex trauma reconstruction.",
        languages: JSON.stringify(["English", "Scottish Gaelic"]),
      ...
      },
      {
        ...
        name: "Yuki Tanaka",
        title: "Dr.",
        specialization: "Micro-Dentistry & Precision Endodontics",
        experience: 11,
        qualifications: "DDS (Tokyo), Certificate in Microscopic Dentistry, Advanced Endodontic Fellowship",
        imageUrl: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Tanaka uses advanced microscopic techniques for ultra-precise dental procedures, specializing in complex endodontic treatments and micro-restorations.",
        languages: JSON.stringify(["English", "Japanese", "Mandarin"]),
        availableDays: JSON.stringify(["Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]),
        createdAt: new Date(),
      },
      {
        ...
        name: "Grace O'Connor",
        title: "Dr.",
        specialization: "Restorative Dentistry & Ceramic Arts",
        experience: 13,
        qualifications: "BDS (Cork), MSc Restorative Dentistry, Certificate in Dental Ceramics",
        imageUrl: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. O'Connor combines technical expertise with artistic skill to create beautiful, functional restorations using the latest ceramic technologies.",
        languages: JSON.stringify(["English", "Irish", "French"]),
        availableDays: JSON.stringify(["Monday", "Tuesday", "Thursday", "Friday"]),
        createdAt: new Date(),
      },
      {
        ...
        title: "Dr.",
        specialization: "Oral Rehabilitation & Complex Cases",
        experience: 18,
        qualifications: "BDS (Cairo), MSc Oral Rehabilitation, Fellowship in Complex Dentistry",
        imageUrl: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Al-Rashid specializes in comprehensive oral rehabilitation for patients with complex dental needs, combining multiple specialties for optimal outcomes.",
        languages: JSON.stringify(["English", "Arabic", "French"]),
        availableDays: JSON.stringify(["Monday", "Wednesday", "Thursday", "Friday", "Saturday"]),
        createdAt: new Date(),
      },
      {
        ...
        name: "Rebecca Walsh",
        title: "Dr.",
        specialization: "Minimally Invasive Dentistry & Biomimetics",
        experience: 9,
        qualifications: "BDS (Dublin), Certificate in Minimally Invasive Dentistry, Biomimetic Specialist",
        imageUrl: "https://images.unsplash.com/photo-1594824694996-aec4a6f4ed73?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
        bio: "Dr. Walsh focuses on preserving natural tooth structure through minimally invasive techniques and biomimetic approaches to dental restoration.",
        languages: JSON.stringify(["English", "Irish", "Spanish"]),
        availableDays: JSON.stringify(["Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]),
        createdAt: new Date(),
      },
    ];
