...
export default function DentistDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed bottom-6 left-6 z-40 animate-in fade-in-50 slide-in-from-bottom-4 duration-1000 hover:opacity-50 hover:scale-110 transition-all duration-300">
